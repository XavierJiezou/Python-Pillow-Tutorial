...
- [Python-Pillow-Tutorial](#python-pillow-tutorial)
  - [1. 引言](#1-引言)
  - [2. 目录](#2-目录)
  - [3. 安装](#3-安装)
  - [4. 教程](#4-教程)
    - [4.1. 使用 Image 类](#41-使用-image-类)
    - [4.2. 读取和保存图像](#42-读取和保存图像)
      - [4.2.1. 将其他格式的图像转换为 JPEG 格式](#421-将其他格式的图像转换为-jpeg-格式)
      - [4.2.2. 创建 JPEG 缩略图](#422-创建-jpeg-缩略图)
    - [4.3. 裁剪、粘贴及合并图像](#43-裁剪粘贴及合并图像)
      - [4.3.1. 裁剪图像](#431-裁剪图像)
      - [4.3.2. 粘贴图像](#432-粘贴图像)
      - [4.3.3. 合并图片](#433-合并图片)
      - [4.3.4. 划分和合并波段](#434-划分和合并波段)
    - [4.4. 几何变换](#44-几何变换)
      - [4.4.1. 缩放和旋转图像](#441-缩放和旋转图像)
      - [4.4.2. 翻转图像](#442-翻转图像)
    - [4.5. 颜色变换](#45-颜色变换)
    - [4.6. 图像增强](#46-图像增强)
      - [4.6.1. 像素点操作](#461-像素点操作)
      - [4.6.2. 高级图像增强](#462-高级图像增强)
    - [4.7. 图像序列](#47-图像序列)
      - [4.7.1. 读取序列](#471-读取序列)
      - [4.7.2. 迭代序列](#472-迭代序列)
    - [4.8. PostScript 打印](#48-postscript-打印)
    - [4.9. 更多读取图片的方式](#49-更多读取图片的方式)
      - [4.9.1. 从打开的文件中读取](#491-从打开的文件中读取)
      - [4.9.2. 从 tar 存档中读取](#492-从-tar-存档中读取)
      - [4.9.3. 批量处理](#493-批量处理)
    - [4.10. 控制解码器](#410-控制解码器)
  - [5. 概念](#5-概念)
    - [5.1. 波段](#51-波段)
    - [5.2. 模式](#52-模式)
    - [5.3. 大小](#53-大小)
